...
export default function Bookings() {
  ...
  return (
    <div className={styles.page}>
      <SectionTitle title="My Bookings" subtitle="Manage your upcoming and past reservations" />
              ...
              <div className={`${styles.card} neo-embed`}>
                ...
                <div className={styles.info}>
                  ...
                  <div className={styles.meta}>
                    <span><FaCalendarAlt /> {b.date}</span>
                    <span><FaUser /> {b.guests}</span>
                    <span><FaBed /> {b.room}</span>
                  </div>
                  <span className={`${styles.status} ${styles['status_' + b.status.toLowerCase()]}`}>{b.status}</span>
                </div>
