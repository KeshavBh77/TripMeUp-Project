  ...
  all: [
    {
      ...
      description: 'An exquisite dining experience offering the finest French and Italian cuisine prepared by our award-winning chef.',
      features: [
    ...
    },
    {
      ...
      description: 'Authentic Japanese sushi experience with fresh fish flown in daily from Tsukiji Market.',
      features: [
    ...
    },
    {
      ...
      description: 'Premium cuts of USDA Prime beef, dry-aged in-house for maximum flavor.',
      features: [
    ...
    <div>
      <section className={styles.hero}>
        ...
        <div className={styles.content}>
          ...
          <p>Find and book the best restaurants for an unforgettable culinary experience</p>
          <div className={styles.searchBar}>
            <input type="text" placeholder="Search for restaurants, cuisines, or locations..." />
      ...
      <div className={styles.container}>
        <SectionTitle title="Featured Restaurants" subtitle="Top-rated dining experiences from around the world" />
