...
const navigate=useNavigate();
  ...
  return (
    <div className={styles.page}>
      <SectionTitle title="My Favorites" subtitle="Your saved places for future trips" />
...
/>
      ...
      <BookingModal
        ...
        onSubmit={({ place, dates, guests }) => console.log('Booking confirmed', place, dates, guests)}
      />
    </div>
  );
}
